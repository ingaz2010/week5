...
public class App {
	...
	public static void main(String[] args) {
		...
		it receives between 3 asterisks on either side of the String (e.g. if the String 
		...
		*/
		...
		Note:  The SpacedLogger should add a space or " " between each character 
		...
		System.out.println(logger1.log("Hello"));
